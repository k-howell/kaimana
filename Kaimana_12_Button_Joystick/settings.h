...
#define _ON_PRESS_BTN_COLOR MAGENTA
...
/*
##IDLE ANIMATION##
You can select an individual animation here from the list, or leave at _IDLE_DEFAULT for the default animation, remove the // from _IDLE_ALL to be able to cycle through the animations using the HOME button
_IDLE_ALL
_IDLE_DEFAULT
...
#define _IDLE_ANIMATION _IDLE_BREATHE_ANIMATION
